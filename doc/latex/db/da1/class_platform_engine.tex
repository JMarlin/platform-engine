...
This function uses a prewritten lua script to initiate a state. This is intended to be the first state that is run by the engine. \hypertarget{class_platform_engine_d3ab75304226ad3fcac6b66ce3cedbc7}{
